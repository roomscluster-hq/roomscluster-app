      ...
      <Card>
        <CardContent className="py-6">
          ...
          <p className="text-sm text-ink-700/60">
            Your organization is on a custom Enterprise plan. Contact us for any changes.
          </p>
        </CardContent>
      </Card>
    );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-ink-700/60">
          ...
          <span className="font-medium text-ink-900">{PLAN_DETAILS[status.plan].label}</span> plan.
        </p>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {(["PRO", "BUSINESS"] as const).map((plan) => {
          ...
          const isDowngradeTarget = status.plan === "BUSINESS" && plan === "PRO";
          ...
          return (
            <Card key={plan} className={isCurrent ? "border-primary-600" : ""}>
              <CardContent className="py-6 flex flex-col h-full">
                ...
                <p className="text-lg font-bold text-ink-900 mb-4">{details.price}</p>
      ...
      <p className="text-xs text-ink-700/50">
        ...
        <a href="mailto:hello@roomscluster.com" className="text-primary-600 hover:underline">
