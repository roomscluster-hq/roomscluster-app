    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full h-10 px-3 pr-10 text-sm border border-surface-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600"
        />
        {showToggle && (
          <button
            type="button"
